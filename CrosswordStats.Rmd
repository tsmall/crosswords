...
The source data is how long it took us to complete each day's puzzle. The NY Times doesn't provide an API to get this data. Plus, I like having my own local copy. So I type our completion times into a CSV file after we finish each puzzle.
